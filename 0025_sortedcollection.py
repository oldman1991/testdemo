...
class SortedCollection(object):
    ...
    def __repr__(self):
        return '{}({},key={})'.format(self.__class__.__name__, self._items,
                                      getattr(self._giveb_key, '__name__', repr(self._giveb_key)))

    def __reduce__(self):
        return self.__class__, (self._items, self._giveb_key)
